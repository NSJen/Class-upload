...
def printAnimal(dictionary):
    ...
    for key,value in dictionary.items():
        ...
        if key == 'Colors':
            ...
            print(f"I don't like these things:") 
            for value in dictionary.values():
                for item in value:
                    item = plural(item)
                    print(item)
...
for dictionary in all_likes: #Need to change this to reflect that they are each dictionaries. Print the values only. 
    #need to break down the key, value pairs. 
